...
const Header = () => {
    ...
    return (
        <header className="h-14 w-full bg-black/80  fixed backdrop-blur-2xl z-50 px-8">

                <div className="h-full w-full flex text-white justify-between items-center gap-10 lg:gap-18">

                    <div className="flex gap-6 items-center justify-center  ">
                        <button onClick={handleHamburger}><RxHamburgerMenu className="text-xl "/></button>
                    ...
                    <div className="flex gap-6 items-center justify-center ">
                        <SearchBar/>
                        <button className="bg-zinc-800/70 p-2.5 rounded-full"><IoMdMic className="text-xl font-light"/></button>
                    </div>
                    {/**/}
                    <div className="flex gap-4 items-center justify-center text-lg mr-4">
                        <button className=" p-2 rounded-full hover:bg-zinc-700/60"><LuArrowUpFromLine className="text-zinc-400"/></button>
                        <button className=" p-2 rounded-full hover:bg-zinc-700/60"><FiBell className="text-xl"/></button>
                        <img id="img" draggable="false" className="style-scope yt-img-shadow rounded-full" alt="Avatar image" height="32" width="32" src="https://yt3.ggpht.com/ytc/AIdro_lAkzvhZEff5lmLuGj59Kp5msF9BCl9v0_OcOoXzvPvNwf6Gl-dhsBFuax-WBfAQX7LXA=s88-c-k-c0x00ffffff-no-rj"/>
                    </div>
                </div>
